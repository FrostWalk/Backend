...
pub(super) fn group_deliverables_scope() -> Scope {
    web::scope("/group-deliverables")
        .route(
            "",
            web::get()
                .to(get_all_group_deliverables_handler)
        ...
        .route(
            "",
            web::post()
                .to(create_group_deliverable_handler)
                .wrap(Admin::require_roles([
                    AvailableAdminRole::Root,
                    AvailableAdminRole::Professor,
                ])),
        ...
        .route(
            "/project/{project_id}",
            web::get()
                .to(get_group_deliverables_for_project_handler)
                .wrap(Admin::require_roles([
                    AvailableAdminRole::Root,
                    AvailableAdminRole::Professor,
                ])),
        ...
        .route(
            "/{id}",
            web::get()
                .to(get_group_deliverable_handler)
                .wrap(Admin::require_roles([
                    AvailableAdminRole::Root,
                    AvailableAdminRole::Professor,
                ])),
        ...
        .route(
            "/{id}/components",
            web::get()
                .to(get_components_for_group_deliverable_handler)
                .wrap(Admin::require_roles([
                    AvailableAdminRole::Root,
                    AvailableAdminRole::Professor,
        ...
        .route(
            "/{id}",
            web::patch()
                .to(update_group_deliverable_handler)
                .wrap(Admin::require_roles([
                    AvailableAdminRole::Root,
                    AvailableAdminRole::Professor,
                ])),
        ...
        .route(
            "/{id}",
            web::delete()
                .to(delete_group_deliverable_handler)
                .wrap(Admin::require_roles([
                    AvailableAdminRole::Root,
                    AvailableAdminRole::Professor,
                ])),
